...
export function Modal({ onClose }: ModalProps) {
	return (
		<section className='fixed flex items-center justify-center w-full top-[17px]' onClick={onClose}>
			<div className='w-[86%] p-8 rounded-2xl bg-black w-full max-w-[560px] shadow-dark mx-7 mt-44 lg:p-16' 
